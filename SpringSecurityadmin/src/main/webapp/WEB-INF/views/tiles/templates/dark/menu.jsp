...
<div class="bs-example">
    <nav role="navigation" class="navbar navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a href="${pageContext.request.contextPath}/" class="navbar-brand"><img src="<c:url value="/static/images/car.png"/>" /></a>
        </div>
...
<%--                 <li class="active"><a href="${pageContext.request.contextPath}/">Accueil</a></li> --%>
                ...
                <li><a href="${pageContext.request.contextPath}/utilisateur/lister">Utilisateur</a>
                <ul>
                <li><a href="${pageContext.request.contextPath}/utilisateur/modifier">Modifier</a></li>
                <li><a href="${pageContext.request.contextPath}/utilisateur/supprimer">Supprimer</a></li>
                </ul>
                </li>
            </ul>
